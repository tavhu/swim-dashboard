...
onMounted(async () => {
  try {
    ...
    if (serviceId.value) {
      ...
      // client's own ទម្រង់ទី២ page both hide the way here when it is not open
        ...
        <section class="col-span-12 rounded-lg bg-white p-4 shadow dark:bg-gray-800 2xl:col-span-6">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <label class="block">
              ...
              <Datepicker :flow="['year', 'month', 'calendar']" :text-input="true" v-model="form.serviceDate" :disabled="readOnly" :enableTimePicker="false"
